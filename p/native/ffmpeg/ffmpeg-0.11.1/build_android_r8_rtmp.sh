...
NDK=/Users/apple/Android/android-ndk-r8
...
BZLIBPATH="/Users/apple/Projects/Player/p/jni/bzip2/"
BZLIB_LDPATHARM="/Users/apple/Projects/Player/p/jni/bzip2"
BZLIB_LDPATHARMV7="/Users/apple/Projects/Player/p/jni/bzip2/armv7-a"


SSLPATH="/Users/apple/Projects/Player/p/native/openssl/"

RTMPPATH="/Users/apple/Projects/Player/p/native/"
RTMPLIB_LDARM="/Users/apple/Projects/Player/p/native/librtmp/armeabi"
RTMPLIB_LDARMV7="/Users/apple/Projects/Player/p/native/librtmp/armeabi-v7a"
...
./configure --target-os=linux \
    ...
    --sysroot=$PLATFORM \
    --extra-cflags=" -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 $OPTIMIZE_CFLAGS -I$RTMPPATH -I$SSLPATH -I$BZLIBPATH -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE" \
    --enable-gpl \
    --enable-version3 \
    --disable-shared \
    --enable-static \
    --extra-ldflags="-Wl,-rpath-link=$PLATFORM/usr/lib -L$PLATFORM/usr/lib -nostdlib -lc -lm -ldl -llog -L$RTMP_LDPATH -lrtmp -lssl -L$BZLIB_LDPATH"\
    --enable-parsers \
    --enable-decoders \
    --enable-demuxers \
    --enable-network \
...
$PREBUILT/bin/arm-linux-androideabi-ld -rpath-link=$PLATFORM/usr/lib -L$PLATFORM/usr/lib -L$RTMP_LDPATH  -soname libffmpeg.so -shared -nostdlib -z,noexecstack -Bsymbolic --whole-archive --no-undefined -o $PREFIX/libffmpeg.so -shared libavcodec/libavcodec.a libavformat/libavformat.a libavutil/libavutil.a libswscale/libswscale.a libswresample/libswresample.a $BZLIB_LDPATH/libbz2.a  -lrtmp -lc -lm -lz -ldl -llog --warn-once  --dynamic-linker=/system/bin/linker $PREBUILT/lib/gcc/arm-linux-androideabi/4.4.3/libgcc.a
