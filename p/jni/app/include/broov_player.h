...
#define VIDEO_QUEUE_BUFFERING_SIZE           10000
#define AUDIO_QUEUE_BUFFERING_SIZE           1000
...
int player_main(int argc, char *argv[], int loop_after_play, int audio_file_type, int sync_type, int seek_duration, int is_stream,int min_audio_buf, int min_video_buf);
int player_exit();
...
// Get the decoded frame from the queue
