...
//#endif
     ...
     //if(JavaExitFromNativePlayerView) {
...
JAVA_EXPORT_NAME(MediaPlayer_nativeResize) ( JNIEnv*  env, jobject  thiz, jint w, jint h )
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
...
JNIEXPORT void JNICALL 
JAVA_EXPORT_NAME(MediaPlayer_nativeDone) ( JNIEnv*  env, jobject  thiz )
{
	__android_log_print(ANDROID_LOG_INFO, "libSDL", "quitting...");
#if SDL_VERSION_ATLEAST(1,3,0)
	SDL_SendQuit();
...
JNIEXPORT void JNICALL 
JAVA_EXPORT_NAME(MediaPlayer_nativeGlContextLost) ( JNIEnv*  env, jobject  thiz )
{
...
JNIEXPORT void JNICALL 
JAVA_EXPORT_NAME(MediaPlayer_nativeGlContextRecreated) ( JNIEnv*  env, jobject  thiz )
{
...
JNIEXPORT void JNICALL 
JAVA_EXPORT_NAME(MediaPlayer_nativeInitJavaCallbacks) ( JNIEnv*  env, jobject thiz )
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
