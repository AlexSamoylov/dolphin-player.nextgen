...
import com.broov.filemanager.FileExplorer;
...
public class Settings extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * hidden_state = i.getExtras().getBoolean("HIDDEN"); subtitle_state =
		 * i.getExtras().getBoolean("SUBTITLE"); audioloop_state =
		 * i.getExtras().getInt("AUDIOLOOP"); videoloop_state =
		 * i.getExtras().getInt("VIDEOLOOP");
		 * 
		 * subtitlesize_state = i.getExtras().getInt("SUBTITLESIZE");
		 * 
		 * color_state = i.getExtras().getInt("COLOR"); sort_state =
		 * i.getExtras().getInt("SORT"); defaulthome_state =
		 * i.getExtras().getString("HOME"); subtitleencoding_state =
		 * i.getExtras().getInt("SUBTITLEENCODING"); subtitlefontfile_state =
		 * i.getExtras().getString("SUBTITLEFONT"); skipframe_state =
		 * i.getExtras().getBoolean("SKIPFRAME");
		 * 
		 * //advanced
		...
		// System.out.println("Inside Settings Activity: skipframes:" +
		// advskipframes_state+" bidirectional:"+advbidirectional_state);
		...
		final String subtitleencoding[] = getResources().getStringArray(
				R.array.SubtitleEncoding);
		...
		final String subtitlesize[] = getResources().getStringArray(
				R.array.SubtitleSize);

		final String advminvideoq[] = getResources().getStringArray(
				R.array.advminvideoq);
		final String advmaxvideoq[] = getResources().getStringArray(
				R.array.advmaxvideoq);
		final String advmaxaudioq[] = getResources().getStringArray(
				R.array.advmaxaudioq);
		final String streamminvideoq[] = getResources().getStringArray(
				R.array.advstreamminvideoq);
		final String streammaxvideoq[] = getResources().getStringArray(
				R.array.advstreammaxvideoq);
		final String streammaxaudioq[] = getResources().getStringArray(
				R.array.advstreammaxaudioq);
		final String yuv2rgb[] = getResources().getStringArray(
				R.array.advyuv2rgb);
		final String pixelformat[] = getResources().getStringArray(
				R.array.advpixelformat);
		final String avsyncmode[] = getResources().getStringArray(
				R.array.advavsyncmode);
		final String advswsscaler[] = getResources().getStringArray(
				R.array.advswsscaler);
		...
		final String sortoptions[] = getResources()
		...
		ImageButton setting_color_btn = (ImageButton) this
				.findViewById(R.id.setting_color_button);
		ImageButton setting_subtitleenconding_btn = (ImageButton) this
				.findViewById(R.id.setting_subtitleencoding_button);
		ImageButton setting_subtitlefontfile_btn = (ImageButton) this
				.findViewById(R.id.setting_subtitlefontfile_button);
		ImageButton setting_subtitlesize_button = (ImageButton) this
				.findViewById(R.id.setting_subtitlesize_button);
		ImageButton setting_audioloop_btn = (ImageButton) this
				.findViewById(R.id.setting_audioloop_button);
		ImageButton setting_videoloop_button = (ImageButton) this
				.findViewById(R.id.setting_videoloop_button);
		ImageButton setting_sort_button = (ImageButton) this
				.findViewById(R.id.setting_sort_button);

		ImageButton setting_yuv2rgb_button = (ImageButton) this
				.findViewById(R.id.setting_yuv2rgb_button);
		ImageButton setting_minvideoqsize_button = (ImageButton) this
				.findViewById(R.id.setting_minvideoqsize_button);
		ImageButton setting_maxvideoqsize_button = (ImageButton) this
				.findViewById(R.id.setting_maxvideoqsize_button);
		ImageButton setting_maxaudioqsize_button = (ImageButton) this
				.findViewById(R.id.setting_maxaudioqsize_button);
		ImageButton setting_streamminvideoqsize_button = (ImageButton) this
				.findViewById(R.id.setting_streamminvideoqsize_button);
		ImageButton setting_streammaxvideoqsize_button = (ImageButton) this
				.findViewById(R.id.setting_streammaxvideoqsize_button);
		ImageButton setting_streammaxaudioqsize_button = (ImageButton) this
				.findViewById(R.id.setting_streammaxaudioqsize_button);
		ImageButton setting_avsyncmode_button = (ImageButton) this
				.findViewById(R.id.setting_avsyncmode_button);

		ImageButton setting_displaypixelformat_button = (ImageButton) this
				.findViewById(R.id.setting_displaypixelformat_button);
		ImageButton setting_swsscaler_button = (ImageButton) this
				.findViewById(R.id.setting_swsscaler_button);

		subtitleFontFileSelected.setText(subtitlefontfile_state);
		subtitleEncodingTypeSelected
				.setText(subtitleencoding[subtitleencoding_state]);
		...
		OnClickListener subtitleEncodingTypeOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.SubtitleEncoding,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int index) {
								subtitleEncodingTypeSelected
										.setText(subtitleencoding[index]);
								subtitleencoding_state = index;
								is.putExtra("SUBTITLEENCODING",
										subtitleencoding_state);
		...
		tblrowSubtitleEncodingType
				.setOnClickListener(subtitleEncodingTypeOnClickListener);
		setting_subtitleenconding_btn
				.setOnClickListener(subtitleEncodingTypeOnClickListener);
				...
				ok_button.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						...
						if (file.exists()) {
							...
							System.out.print("OK button click:"
									+ subtitlefontfile_state);
							subtitlefontfile_changed = true;
							is.putExtra("SUBTITLEFONT", subtitlefontfile_state);
							SaveSettings();
							Toast.makeText(context,
									R.string.setasdefaultsubtitlefont,
									Toast.LENGTH_LONG).show();
							dialog.dismiss();

						} else {
							Toast.makeText(context,
									R.string.setavalidsubtitlefontfile,
									Toast.LENGTH_LONG).show();
						}
					}
				});
		...
		tblrowsubtitleFontFile
				.setOnClickListener(subtitleFontFileClickListener);
		setting_subtitlefontfile_btn
				.setOnClickListener(subtitleFontFileClickListener);
		...
		OnClickListener colorClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.Colors,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int index) {
								switch (index) {
								...
								System.out.println(color_state);
								color_changed = true;

								// AA CHANGED 03 SEP 2012
								SaveSettings();
							}
		...
		tblrowadvancedskipbidirectionalframes
		...
		skipbidirectionalframes_bx
				.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
					@Override
					public void onCheckedChanged(CompoundButton arg0,
							boolean arg1) {
						advbidirectional_state = skipbidirectionalframes_bx
								.isChecked();
		...
		OnClickListener subtitlesizeOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.SubtitleSize,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("SUBTITLESIZE",
											subtitlesize_state);
									subtitlesizeSelected
											.setText(subtitlesize[0]);
									break;
		...
		setting_subtitlesize_button
				.setOnClickListener(subtitlesizeOnClickListener);
		...
		OnClickListener loopswsscalerOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advswsscaler,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVSWSSCALER",
											advswsscaler_state);
									advswsscalerloopSelected
											.setText(advswsscaler[0]);
									break;
		...
		tblrowadvancedadvswsscaler
				.setOnClickListener(loopswsscalerOnClickListener);
		setting_swsscaler_button
				.setOnClickListener(loopswsscalerOnClickListener);
		...
		OnClickListener loopyuv2rgbOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advyuv2rgb,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
		...
		OnClickListener looppixelformatOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advpixelformat,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVPIXELFORMAT",
											advpixelformat_state);
									pixelformatloopSelected
											.setText(pixelformat[0]);
									break;
		...
		tblrowadvancedpixelformat
				.setOnClickListener(looppixelformatOnClickListener);
		setting_displaypixelformat_button
				.setOnClickListener(looppixelformatOnClickListener);
		...
		OnClickListener loopavsyncmodeOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advavsyncmode,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVAVSYNCMODE",
											advavsyncmode_state);
									advavsyncmodeloopSelected
											.setText(avsyncmode[0]);
									break;
		...
		tblrowadvancedavsyncmode
				.setOnClickListener(loopavsyncmodeOnClickListener);
		setting_avsyncmode_button
				.setOnClickListener(loopavsyncmodeOnClickListener);
		...
		OnClickListener loopadvminvideoqOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advminvideoq,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVMINVIDEOQ",
											advminvideoq_state);
									minvideoqloopSelected
											.setText(advminvideoq[0]);
									break;
		...
		tblrowadvancedminvideoqsize
				.setOnClickListener(loopadvminvideoqOnClickListener);
		setting_minvideoqsize_button
				.setOnClickListener(loopadvminvideoqOnClickListener);
		...
		OnClickListener loopadvmaxvideoqOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advmaxvideoq,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVMAXVIDEOQ",
											advmaxvideoq_state);
									maxvideoqloopSelected
											.setText(advmaxvideoq[0]);
									break;
		...
		tblrowadvancedmaxvideoqsize
				.setOnClickListener(loopadvmaxvideoqOnClickListener);
		setting_maxvideoqsize_button
				.setOnClickListener(loopadvmaxvideoqOnClickListener);
		// advmaxaudioq
		OnClickListener loopadvmaxaudioqOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advmaxaudioq,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVMAXAUDIOQ",
											advmaxaudioq_state);
									maxaudioqloopSelected
											.setText(advmaxaudioq[0]);
									break;
		...
		tblrowadvancedmaxaudioqsize
				.setOnClickListener(loopadvmaxaudioqOnClickListener);
		setting_maxaudioqsize_button
				.setOnClickListener(loopadvmaxaudioqOnClickListener);
		// stream
		OnClickListener loopadvstreamminvideoqOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advstreamminvideoq,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVSTREAMMINVIDEOQ",
											advstreamminvideoq_state);
									streamminvideoqloopSelected
											.setText(streamminvideoq[0]);
									break;
		...
		tblrowadvancedstreamminvideoqsize
				.setOnClickListener(loopadvstreamminvideoqOnClickListener);
		setting_streamminvideoqsize_button
				.setOnClickListener(loopadvstreamminvideoqOnClickListener);
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								case 0:
									...
									is.putExtra("ADVSTREAMMAXVIDEOQ",
											advstreammaxvideoq_state);
									streammaxvideoqloopSelected
											.setText(streammaxvideoq[0]);
									break;
		...
		tblrowadvancedstreammaxvideoqsize
				.setOnClickListener(loopadvstreammaxvideoqOnClickListener);
		setting_streammaxvideoqsize_button
				.setOnClickListener(loopadvstreammaxvideoqOnClickListener);
		// advmaxaudioq
		OnClickListener loopadvstreammaxaudioqOnClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				builder.setItems(R.array.advstreammaxaudioq,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog,
									int index) {
								...
								case 0:
									...
									is.putExtra("ADVSTREAMMAXAUDIOQ",
											advstreammaxaudioq_state);
								...
								case 12:
									...
									advstreammaxaudioq_changed = true;
									is.putExtra("ADVMAXSTREAMAUDIOQ",
											advstreammaxaudioq_state);
									streammaxaudioqloopSelected
											.setText(advmaxaudioq[12]);
									break;
		...
		tblrowadvancedstreammaxaudioqsize
				.setOnClickListener(loopadvstreammaxaudioqOnClickListener);
		setting_streammaxaudioqsize_button
				.setOnClickListener(loopadvstreammaxaudioqOnClickListener);
	}
	...
	protected void onResume() {
		...
		if (!defaulthome_changed) {
			System.out.println("settings result return defaulthome_state:"
					+ defaulthome_state);
	...
	public void readSettings() {
		...
		hidden_state = Globals.dbHide;
		subtitle_state = Globals.dbSubtitle;
		audioloop_state = Globals.dbAudioLoop;
		videoloop_state = Globals.dbVideoLoop;

		subtitlesize_state = Globals.dbSubtitleSize;

		color_state = Globals.dbColor;
		sort_state = Globals.dbSort;
		defaulthome_state = Globals.dbDefaultHome;
		subtitleencoding_state = Globals.dbSubtitleEncoding;
		subtitlefontfile_state = Globals.dbSubtitleFont;
		skipframe_state = Globals.dbSkipframes;

		// advanced
		advskipframes_state = Globals.dbadvancedskip;
		advbidirectional_state = Globals.dbadvancedbidirectional;
		advffmpeg_state = Globals.dbadvancedffmpeg;
		advyuv2rgb_state = Globals.dbadvancedyuv;
		advpixelformat_state = Globals.dbadvancedpixelformat;
		advminvideoq_state = Globals.dbadvancedminvideoq;
		advmaxvideoq_state = Globals.dbadvancedmaxvideoq;
		advmaxaudioq_state = Globals.dbadvancedmaxaudioq;
		advstreamminvideoq_state = Globals.dbadvancedstreamminvideoq;
		advstreammaxvideoq_state = Globals.dbadvancedstreammaxvideoq;
		advstreammaxaudioq_state = Globals.dbadvancedstreammaxaudioq;
		advdebug_state = Globals.dbadvanceddebug;
		advavsyncmode_state = Globals.dbadvancedavsyncmode;
		advswsscaler_state = Globals.dbadvancedswsscaler;
